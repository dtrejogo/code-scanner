package com.fidku.geoluks.social.instagram;
...
import com.fidku.geoluks.social.instagram.InstagramDialog.OAuthDialogListener;
...
/**
 * 
 * @author Jhossept Romero <jhossept.romero@fidku.com>
 * 
 */
		...
		new Thread() {
			...
			public void run() {
				...
				try {
					...
					Log.d(TAG,
							"Opening URL " + API_URL + "/users/"
									+ mSession.getId() + "/?access_token="
									+ mAccessToken);
					/*
					 ...
					 * System.out.println(response); JSONObject jsonObj =
					...
					client.get(urlString, new AsyncHttpResponseHandler() {
						public void onSuccess(JSONObject jsonObj) {
							String name;
							try {
								name = jsonObj.getJSONObject("data").getString(
										"full_name");
